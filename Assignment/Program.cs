    ...
    class Program
    {
        ...
        */
        ...
        public static IList<int> MoveZeroes(int[] nums)
        {
            try
            {
                // Write your code here and you can modify the return value according to the requirements
                int index = 0;
                //Loop through the array to move non-zero elements to the beginning

                foreach (int num in nums)
                {
                    // If the element is non-zero, move it to the beginning of the array
                    if (num != 0)
                    {
                        nums[index] = num;// Move the non-zero element to the current index
                        index++;
                    }
                }
        ...
        */
        ...
        public static IList<IList<int>> ThreeSum(int[] nums)
        {
            ...
            {
                // Write your code here and you can modify the return value according to the requirements
                Array.Sort(nums); // Sort the array to easily handle duplicates
                IList<IList<int>> triplets = new List<IList<int>>(); // Initialize a list to store triplets
                // Loop through the sorted array to find triplets
        ...
        */
        ...
        public static int FindMaxConsecutiveOnes(int[] nums)
        {
            try
            {
                ...
                // Loop through the array to find the maximum consecutive ones
                foreach (int num in nums)
                {
                    if (num == 1)
                    {
        ...
        */
        ...
        public static int MaximumGap(int[] nums)
        {
            try
            {
                ...
                // Find the minimum and maximum values in nums array
                foreach (int num in nums)
                {
                ...
                int bucketSize = Math.Max(1, (maxVal - minVal) / (nums.Length - 1));// Calculate the size of each bucket

                
                int bucketCount = (maxVal - minVal) / bucketSize + 1;// Calculate the number of buckets needed
                ...
                // Sort each bucket and calculate maximum gap
                int maxGap = 0;
                int prevMax = minVal;
